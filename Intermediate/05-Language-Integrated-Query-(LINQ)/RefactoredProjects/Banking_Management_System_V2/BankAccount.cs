...
namespace Banking_Management_System_V2
{
    ...
    public record Transaction(decimal Amount, DateTime Date, TransactionType transactionType) : ITransactionEntry
    {
    ...
    // a record for daily transaction total
    ...
    public abstract class BankAccount
    {
        ...
        {
            _ledger.Add(new Transaction(amount, DateTime.Now, transactionType));
        }
